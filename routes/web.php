...
//    Route::get('/', 'CRM\ClientsController@processListOfClients')->name('clients');
//    Route::get('form/create', 'CRM\ClientsController@showCreateForm')->name('showCreateForm');
//    Route::get('form/update/{clientId}', 'CRM\ClientsController@showUpdateForm')->name('showUpdateForm');
//    Route::get('view/{clientId}', 'CRM\ClientsController@viewClientDetails')->name('viewClientDetails');
//    Route::post('store', 'CRM\ClientsController@processCreateClient')->name('processCreateClient');
//    Route::put('update/{clientId}', 'CRM\ClientsController@processUpdateClient')->name('processUpdateClient');
//    Route::delete('delete/{clientId}', 'CRM\ClientsController@processDeleteClient')->name('processDeleteClient');
//    Route::get('set-active/{id}/{value}', 'CRM\ClientsController@processSetIsActive')->name('processSetIsActive');
//});
//
