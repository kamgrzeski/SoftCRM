                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                {{ Form::label('job', 'Job') }}
                                {{ Form::text('job', null, array('class' => 'form-control', 'placeholder' => \App\Language::getMessage('messages.InputText'))) }}
                            </div>
                            <div class="form-group">
                                {{ Form::label('note', 'Notatnik') }}
                                {{ Form::textarea('note', null, array('class' => 'form-control', 'placeholder' => \App\Language::getMessage('messages.InputText'))) }}
                            </div>
                        </div>
