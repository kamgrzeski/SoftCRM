<!DOCTYPE html>
<html lang="pl">
@include('layouts.head', ['title' => 'Edit company'])
        ...
        <main class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="w-full bg-white shadow-md rounded-lg mb-3">
                <div class="p-6 flex justify-between items-center">
                    <p class="text-xl">Edit company: {{ $company->name }}</p>
                    <a href="{{ url()->previous() }}">
                ...
                <div class="p-6">
                    <form action="{{ route('companies.update', $company) }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                @include('layouts.components.forms.input', [
                                    ...
                                    'inputType' => 'text',
                                    'inputValue' => $company->billing_address,
                                    'inputRequired' => true
                                ])
                            ...
                            <div>
                                @include('layouts.components.forms.input', [
                                    ...
                                    'inputType' => 'text',
                                    'inputValue' => $company->postal_code,
                                    'inputRequired' => true
                                ])
                                ...
                                @include('layouts.components.forms.input', [
                                    ...
                                    'inputType' => 'text',
                                    'inputValue' => $company->employees_size,
                                    'inputRequired' => true
                                ])
                                    ...
                                    <div class="flex">
                                        ...
                                        <select id="client_id" name="client_id" required
                                            ...
                                            @foreach($clients as $client)
                                                <option value="{{ $client->id }}" @if($company->client_id == $client->id) selected @endif>{{ $client->full_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                @include('layouts.components.forms.textarea', [
                                    ...
                                    'inputValue' => $company->description,
                                    'inputRequired' => false
                                ])
                        ...
                        <div class="flex justify-end border-t border-gray-200">
                            <button type="submit" class="bg-blue-500 mt-3 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Edit company</button>
                        </div>
                    </form>
                </div>
            </div>
