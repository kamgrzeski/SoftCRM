                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group input-row">
                                ...
                                {{ Form::text('name', rol', 'placeholder' => \App\Models\Language::getMessage('messages.InputText'), array('class' => 'form-control')) }}
                            </div>
                            <div class="form-group input-row">
                                {{ Form::label('type', 'Type') }}
                                {{ Form::text('type', rol', 'placeholder' => \App\Models\Language::getMessage('messages.InputText'), array('class' => 'form-control')) }}
                            </div>
                            <div class="form-group input-row">
                                {{ Form::label('number', 'Number') }}
                                {{ Form::text('number', rol', 'placeholder' => \App\Models\Language::getMessage('messages.InputText'), array('class' => 'form-control')) }}
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group input-row">
                                {{ Form::label('subject', 'Subject') }}
                                {{ Form::text('subject', rol', 'placeholder' => \App\Models\Language::getMessage('messages.InputText'), array('class' => 'form-control')) }}
                            </div>
                            <div class="form-group input-row">
                                {{ Form::label('cost', 'Cost') }}
                                {{ Form::text('cost', rol', 'placeholder' => \App\Models\Language::getMessage('messages.InputText'), array('class' => 'form-control')) }}
                            </div>
                        </div>
